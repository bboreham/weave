...
func (s *Space) biggestFreeRange(r address.Range) (biggest address.Range, biggestSize address.Offset) {
	s.walkFree(r, func(chunk address.Range) bool {
...
func (s *Space) Donate(r address.Range) (address.Range, bool) {
	biggest, size := s.biggestFreeRange(r)
	...
	biggest.Start = address.Add(biggest.Start, size/2)
